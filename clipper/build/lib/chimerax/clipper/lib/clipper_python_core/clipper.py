...
class Util(_object):
    ...
    if _newclass:
        ...
        is_nan_float = _clipper.Util_is_nan_float
    if _newclass:
        is_nan_double = staticmethod(_clipper.Util_is_nan_double)
    else:
        is_nan_double = _clipper.Util_is_nan_double
    if _newclass:
...
class mat33_double(_object):
    ...
    if _newclass:
        ...
        identity = _clipper.mat33_double_identity
    if _newclass:
        null = staticmethod(_clipper.mat33_double_null)
    else:
        null = _clipper.mat33_double_null
