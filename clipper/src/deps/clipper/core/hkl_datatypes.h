...
namespace clipper
{
  ...
  namespace data32
  {
    typedef CLIPPER_IMEX clipper::datatypes::I_sigI<ftype32> I_sigI;          //!< datatype
    typedef CLIPPER_IMEX clipper::datatypes::I_sigI_ano<ftype32> I_sigI_ano;  //!< datatype
    typedef CLIPPER_IMEX clipper::datatypes::F_sigF<ftype32> F_sigF;          //!< datatype
    typedef CLIPPER_IMEX clipper::datatypes::F_sigF_ano<ftype32> F_sigF_ano;  //!< datatype
    typedef CLIPPER_IMEX clipper::datatypes::E_sigE<ftype32> E_sigE;          //!< datatype
    typedef CLIPPER_IMEX clipper::datatypes::F_phi<ftype32> F_phi;            //!< datatype
    typedef CLIPPER_IMEX clipper::datatypes::Phi_fom<ftype32> Phi_fom;        //!< datatype
    typedef CLIPPER_IMEX clipper::datatypes::ABCD<ftype32> ABCD;              //!< datatype
    typedef CLIPPER_IMEX clipper::datatypes::Flag Flag;                       //!< datatype
    typedef CLIPPER_IMEX clipper::datatypes::Flag_bool Flag_bool;             //!< datatype
    typedef CLIPPER_IMEX clipper::datatypes::D_sigD<ftype32> D_sigD;          //!< datatype
  }

  namespace data64
  {
    typedef CLIPPER_IMEX clipper::datatypes::I_sigI<ftype64> I_sigI;          //!< datatype
    typedef CLIPPER_IMEX clipper::datatypes::I_sigI_ano<ftype64> I_sigI_ano;  //!< datatype
    typedef CLIPPER_IMEX clipper::datatypes::F_sigF<ftype64> F_sigF;          //!< datatype
    typedef CLIPPER_IMEX clipper::datatypes::F_sigF_ano<ftype64> F_sigF_ano;  //!< datatype
    typedef CLIPPER_IMEX clipper::datatypes::E_sigE<ftype64> E_sigE;          //!< datatype
    typedef CLIPPER_IMEX clipper::datatypes::F_phi<ftype64> F_phi;            //!< datatype
    typedef CLIPPER_IMEX clipper::datatypes::Phi_fom<ftype64> Phi_fom;        //!< datatype
    typedef CLIPPER_IMEX clipper::datatypes::ABCD<ftype64> ABCD;              //!< datatype
    typedef CLIPPER_IMEX clipper::datatypes::Flag Flag;                       //!< datatype
    typedef CLIPPER_IMEX clipper::datatypes::Flag_bool Flag_bool;             //!< datatype
    typedef CLIPPER_IMEX clipper::datatypes::D_sigD<ftype64> D_sigD;          //!< datatype
  }
