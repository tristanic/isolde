...
template class CLIPPER_IMEX EDcalc_mask<ftype32>;
template class CLIPPER_IMEX EDcalc_mask<ftype64>;
template class CLIPPER_IMEX EDcalc_iso<ftype32>;
template class CLIPPER_IMEX EDcalc_iso<ftype64>;
template class CLIPPER_IMEX EDcalc_aniso<ftype32>;
template class CLIPPER_IMEX EDcalc_aniso<ftype64>;
