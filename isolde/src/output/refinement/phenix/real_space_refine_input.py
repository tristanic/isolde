...
def write_real_space_refine_defaults(session, model, volume, resolution, file_name=None, 
    ...
    if file_name is None:
        file_name = 'real_space_refine.eff'
...
pdb_interpretation {{
    ...
    import os
    session.logger.info(
        f'A phenix.real_space_refine input file {file_name} with settings recommended for ISOLDE models has been written to '
        ...
        f'phenix.real_space_refine {file_name}.'
    )
