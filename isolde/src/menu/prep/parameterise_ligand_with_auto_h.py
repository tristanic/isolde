...
tooltip = ('Parameterise the selected residue for MD, letting phenix.elbow decide the hydrogens.')
...
def run_script(session):
    ...
    parameterise_residue_with_elbow(sel, include_hydrogens=False, keep_elbow_files=False)
