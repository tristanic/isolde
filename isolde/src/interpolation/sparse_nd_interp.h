...
template <typename T>
class SparseRegularGridInterpolator
{

public:
    SparseRegularGridInterpolator(); // null constructor
    ~SparseRegularGridInterpolator() {} // destructor
     ...
     */
    SparseRegularGridInterpolator(const size_t &dim, size_t* n, T* min, T* max, const size_t &n_data, T* data_coords, T* data);
    ...
    const sparse_array<size_t, T> &data() const {return _data;}
